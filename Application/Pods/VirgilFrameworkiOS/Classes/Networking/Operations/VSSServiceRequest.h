...
typedef NS_ENUM(NSInteger, ServiceRequestStatus) {
    None,
    InProgress,
    Done,
    Failed
 ...
 */
typedef void (^ServiceRequestResponseBodyHandler)(VSSServiceRequest * __nonnull request, NSData * __nonnull bodyChunk);
 ...
 */
@interface VSSServiceRequest : NSOperation <NSURLConnectionDataDelegate>
