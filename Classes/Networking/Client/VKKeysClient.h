 ...
 * @param privateKey NSData Private key data corresponding the public key which is about to be created. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 ...
 * @param privateKey NSData Private key data corresponding the public key which is need to be updated ("old" public key). It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the "old" public key.
 * @param keyPassword NSString Password which was used to create a key pair object ("old") or nil if key pair was created without a password.
 ...
 * @param privateKey NSData Private key data corresponding the public key which is about to be deleted. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 * @param keyPassword NSString Password which was used to create a key pair object or nil if key pair was created without a password.
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
 ...
 * @param privateKey NSData Private key data corresponding the public key which is need to be get. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 * @param keyPassword NSString Password which was used to create a key pair object or nil if key pair was created without a password.
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
 ...
 * @param privateKey NSData Private key data corresponding the public key. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 * @param keyPassword NSString Password which was used to create a key pair object or nil if key pair was created without a password.
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
