 ...
 * @param publicKey VKPublicKey Model object containing actual public key data and a list of VKUserData instances attached to that public key. The list should contain at least one user data instance with UDCUserId Class.
 * @param privateKey VFPrivateKey Private key container corresponding the public key which is about to be created. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 ...
 */
- (void)createPublicKey:(VKPublicKey * __nonnull)publicKey privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(VKPublicKey *__nullable pubKey, NSError * __nullable error))completionHandler;
/**
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)getPublicKeyId:(GUID * __nonnull)publicKeyId completionHandler:(void(^ __nullable)(VKPublicKey * __nullable pubKey, NSError * __nullable error))completionHandler;
/**
 ...
 * @param privateKey VFPrivateKey Private key container corresponding the public key which is need to be updated ("old" public key). It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the "old" public key.
 * @param keyPair VCKeyPair instance containing the public key data which will be used as update for existing "old" public key. Whole key pair is necessary to compose request sign to make service sure that user is actual owner of this key pair.
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)updatePublicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey newKeyPair:(VCKeyPair * __nonnull)keyPair newKeyPassword:(NSString * __nullable)newKeyPassword completionHandler:(void(^ __nullable)(VKPublicKey * __nullable pubKey, NSError * __nullable error))completionHandler;
/**
 ...
 * @param privateKey VFPrivateKey Private key container corresponding the public key which is about to be deleted. It is necessary to compose X-VIRGIL-REQUEST-SIGN header to make service sure that user is actual owner of the public key.
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)deletePublicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(VKActionToken *__nullable actionToken, NSError * __nullable error))completionHandler;
/**
 ...
 * @param keyPair VCKeyPair instance containing the new public key data which will be used as new user's public key. Also the new private key is necessary to compose request sign to make service sure that user is actual owner of this key pair.
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)resetPublicKeyId:(GUID * __nonnull)publicKeyId keyPair:(VCKeyPair * __nonnull)keyPair keyPassword:(NSString * __nullable)keyPassword completionHandler:(void(^ __nullable)(VKActionToken * __nullable actionToken, NSError * __nullable error))completionHandler;
/**
 ...
 * @param actionToken VKActionToken Data structure containing confirmation codes for all requested by the Service user data objects. This is necessary to make Service sure that user is actual owner of the all user data attached to the public key.
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)persistPublicKeyId:(GUID * __nonnull)publicKeyId actionToken:(VKActionToken * __nonnull)actionToken completionHandler:(void(^ __nullable)(VKPublicKey *__nullable pubKey, NSError * __nullable error))completionHandler;
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)searchPublicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(VKPublicKey *__nullable pubKey, NSError * __nullable error))completionHandler;
/**
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)searchPublicKeyUserIdValue:(NSString * __nonnull)value completionHandler:(void(^ __nullable)(VKPublicKey * __nullable pubKey, NSError * __nullable error))completionHandler;
 ...
 * @param userData VKUserData Model object containing actual new user data instance.
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)createUserData:(VFUserData * __nonnull)userData publicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(VKUserData * __nullable uData, NSError * __nullable error))completionHandler;
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)deleteUserDataId:(GUID * __nonnull)userDataId publicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(NSError * __nullable error))completionHandler;
/**
 ...
 * @param completionHandler Block with callback code which should be called in case of request completion due to success or error. In case of success NSError parameter of the callback will be nil. Otherwise it will contain error information. 
 */
- (void)resendConfirmationUserDataId:(GUID * __nonnull)userDataId publicKeyId:(GUID * __nonnull)publicKeyId privateKey:(VFPrivateKey * __nonnull)privateKey completionHandler:(void(^ __nullable)(NSError * __nullable error))completionHandler;
