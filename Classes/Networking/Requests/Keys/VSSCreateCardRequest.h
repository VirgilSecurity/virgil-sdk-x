...
- (instancetype __nonnull)initWithContext:(VSSRequestContext * __nonnull)context publicKeyId:(GUID * __nonnull)pkId identityInfo:(VSSIdentityInfo * __nonnull)identityInfo data:(NSDictionary * __nullable)data signs:(NSArray <NSDictionary *>* __nullable)signs;
...
- (instancetype __nonnull)initWithContext:(VSSRequestContext * __nonnull)context publicKey:(NSData * __nonnull)publicKey identityInfo:(VSSIdentityInfo * __nonnull)identityInfo data:(NSDictionary * __nullable)data signs:(NSArray <NSDictionary *>* __nullable)signs;
