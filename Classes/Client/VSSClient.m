...
//#warning Remove this code. Now client will receive public keys on startup
...
//        VSSSearchCardsCriteria *criteria = [[VSSSearchCardsCriteria alloc] initWithScope:VSSCardScopeGlobal identityType:@"" identities:(NSArray<NSString *> * _Nonnull)]
//        VSSSearchAppCardRequest *cardSearchRequest = [[VSSSearchCardRequest alloc] initWithContext:context value:[self.serviceConfig serviceCardValueForServiceID:serviceID]];
