...
Use the [approve & publish users guide](/documentation-objectivec/guides/configuration/server-configuration.md) to publish user's Virgil Card on Virgil Services.
...
![encrypted storage](/documentation-objectivec/img/encrypted_storage_upload.png "Encrypt data")
...
See our [guide](/documentation-objectivec/guides/virgil-card/finding-card.md) on Finding Cards for best practices on loading Alice's card.
...
![Encrypt Data](/documentation-objectivec/img/encrypted_storage_download.png "Decrypt Data")
...
To decrypt data, you will need your stored Virgil Key. See the [Loading Key](/documentation-objectivec/guides/virgil-key/loading-key.md) guide for more details.
