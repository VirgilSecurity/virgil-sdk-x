...
![Virgil Card](https://github.com/VirgilSecurity/virgil-sdk-swift/blob/docs-review/documentation/img/Card_introduct.png "Create Virgil Card")
...
Read more about Virgil Cards and their types [here](https://github.com/VirgilSecurity/virgil-sdk-swift/blob/docs-review/documentation/guides/virgil-card/creating-card.md).
...
Use the [approve & publish users guide](https://github.com/VirgilSecurity/virgil-sdk-swift/blob/docs-review/documentation/guides/configuration/server-configuration.md) to publish users Virgil Cards on Virgil Services.
