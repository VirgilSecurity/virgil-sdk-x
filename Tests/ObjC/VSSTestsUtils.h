...
- (VSSRevokeEmailCardRequest * __nonnull)instantiateRevokeGlobalCardForCard:(VSSCard * __nonnull)card validationToken:(NSString * __nonnull)validationToken withPrivateKey:(VSSPrivateKey * __nonnull)privateKey;
...
- (BOOL)checkRevokeGlobalCardRequest:(VSSRevokeEmailCardRequest * __nonnull)request1 isEqualToRevokeGlobalCardRequest:(VSSRevokeEmailCardRequest * __nonnull)request2;
